...
{
    std::cout
        <<last_generation.average_cost<<"\t"<<last_generation.best_total_cost<<std::endl;
...
int main()
{
    output_file.open("‪C:/evolution/result_so-rastrigin.txt");
    output_file
        <<"step"<<"\t"
        <<"cost_avg"<<"\t"
        <<"cost_best"<<"\t"
